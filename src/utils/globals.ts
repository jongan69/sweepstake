...
export const DEFAULT_WALLET = "4cZdnc2DF1tb5aH3jRTLJLxpqiurVVZkEhjpwTyScDH9"; // Dustfolio
export const SOL_MINT = "So11111111111111111111111111111111111111112"; // Solana
export const REFERAL_ADDRESS = "2J8jsZmyTRwCYfX4aAKqdh763Y2UHMudnRh7b9Z9hBXE"; // Jupiter Swap Referral Public Key
export const REFERAL_TOKEN_ADDRESS = "E2DXwH2LXXGpi9pjxdYmmJZfGrVVBWfE6rR6q8B1NH6h"; // Jupiter Swap Referral Token Address
