...
import { JUPITER_PROJECT, SOL_MINT } from "./globals";
  ...
  try {
    ...
    try {
      ...
      if (error instanceof Error && error.message.includes('Account not found')) {
        ...
        console.warn('Unexpected error checking existing accounts:', error);
        throw error;
      }
    }
    ...
    try {
      ...
      console.warn('Error creating referral account:', error);
    ...
    console.warn('Error creating referral accounts:', error);
